...
case "$ARCH" in
    x86_64)
        ...
        wget https://github.com/hemilabs/heminetwork/releases/download/v0.5.0/heminetwork_v0.5.0_linux_amd64.tar.gz -O heminetwork.tar.gz
        ;;
    aarch64)
        log "INFO" "Detected arm64 architecture. Downloading Hemi Network Binary..."
        wget https://github.com/hemilabs/heminetwork/releases/download/v0.5.0/heminetwork_v0.5.0_linux_arm64.tar.gz -O heminetwork.tar.gz
        ;;
    *)
